...
func TestNewDeployFlags(t *testing.T) {
	...
	testUint16Flag(t, app, &deployFlags.Units, testSptr("deploy"), "units", nil, testU16ptr(1), nil)
	...
	testStringFlag(t, app, &deployFlags.ECRNamespace, testSptr("deploy"), "ecr-namespace", nil, testSptr("coldbrew"), nil)
